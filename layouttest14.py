...
"border-radius: 10px;")
        ...
        self.accountMainVLayout.addItem(spacerItem2)
...
"}")
        ...
        self.accountMainVHLayout.addItem(spacerItem3)
        # self.accountMainVHLayout.setStretch(0, 1)
...
"margin-left: 10px;")
        ...
        self.accountMainVLayout.addItem(spacerItem4)
...
"min-height: 150;")
        ...
        self.btnSeguimiento.clicked.connect(lambda: self.changePage(2))
        self.btnBusqueda.clicked.connect(lambda: self.changePage(3))
        self.btnUser.clicked.connect(lambda: self.changePage(4))
