...
"text-align: left")
        ...
        self.loginMainFrame = QtWidgets.QFrame(self.gridLayoutWidget_2)
        self.loginMainFrame.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius: 0px;")
        ...
        self.loginGrid.addWidget(self.loginMainFrame, 1, 1, 1, 1)
        ...
        self.loginGrid.setColumnStretch(0, 1)
        self.loginGrid.setColumnStretch(1, 2)
        self.loginGrid.setColumnStretch(2, 1)
        ...
        # NOTE(Erton): Stacked widget index here
