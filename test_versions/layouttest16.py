...
"border-radius: 10px;")
        ...
        self.seguimientoClassTitle_2 = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        font = QtGui.QFont()
        font.setFamily("Ubuntu Light")
        font.setPointSize(16)
        self.seguimientoClassTitle_2.setFont(font)
        self.seguimientoClassTitle_2.setStyleSheet("color: rgb(8, 21, 63);")
        self.seguimientoClassTitle_2.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.seguimientoClassTitle_2.setObjectName("seguimientoClassTitle_2")
        self.seguimientoMarkVLayout.addWidget(self.seguimientoClassTitle_2)
        self.calendarioAddForm_3 = QtWidgets.QGridLayout()
        self.calendarioAddForm_3.setObjectName("calendarioAddForm_3")
        self.calendarioAddBtn1_3 = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.calendarioAddBtn1_3.setStyleSheet("QPushButton {\n"
"    border-width: 0px;\n"
"    color: rgb(255, 255, 255);\n"
"    background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0, stop:0 rgba(28, 85, 255, 255), stop:1 rgba(94, 134, 255, 255));\n"
"    padding: 6.5px;\n"
...
"    background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0, stop:0 rgba(32, 81, 227, 255), stop:1 rgba(71, 109, 224, 255));\n"
"}")
        self.calendarioAddBtn1_3.setObjectName("calendarioAddBtn1_3")
        self.calendarioAddForm_3.addWidget(self.calendarioAddBtn1_3, 4, 3, 1, 1)
        self.calendarioAddCombo2_2 = QtWidgets.QComboBox(self.verticalLayoutWidget_4)
        self.calendarioAddCombo2_2.setStyleSheet("QComboBox {\n"
"    color: rgb(0, 0, 0);\n"
"    border-style: solid;\n"
"    border-width: 1px;\n"
"    border-radius: 5px;\n"
...
"    selection-color: rgb(246, 246, 246);\n"
"}")
        self.calendarioAddCombo2_2.setObjectName("calendarioAddCombo2_2")
        self.calendarioAddCombo2_2.addItem("")
        self.calendarioAddCombo2_2.addItem("")
        self.calendarioAddForm_3.addWidget(self.calendarioAddCombo2_2, 4, 2, 1, 1)
        self.calendarioAddLabel0_3 = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        self.calendarioAddLabel0_3.setStyleSheet("color: rgb(151, 151, 151);")
        self.calendarioAddLabel0_3.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.calendarioAddLabel0_3.setObjectName("calendarioAddLabel0_3")
        self.calendarioAddForm_3.addWidget(self.calendarioAddLabel0_3, 3, 0, 1, 1)
        self.calendarioAddLineEdit_3 = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.calendarioAddLineEdit_3.setStyleSheet("QLineEdit {\n"
"    color: rgb(0, 0, 0);\n"
"    border-style: solid;\n"
"    border-width: 1px;\n"
"    border-radius: 5px;\n"
...
"    border-width: 2px;\n"
"}")
        self.calendarioAddLineEdit_3.setObjectName("calendarioAddLineEdit_3")
        self.calendarioAddForm_3.addWidget(self.calendarioAddLineEdit_3, 4, 0, 1, 1)
        self.calendarioAddLabel2_2 = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        self.calendarioAddLabel2_2.setStyleSheet("color: rgb(151, 151, 151);")
        self.calendarioAddLabel2_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.calendarioAddLabel2_2.setObjectName("calendarioAddLabel2_2")
        self.calendarioAddForm_3.addWidget(self.calendarioAddLabel2_2, 3, 2, 1, 1)
        self.calendarioAddCombo1_2 = QtWidgets.QComboBox(self.verticalLayoutWidget_4)
        self.calendarioAddCombo1_2.setStyleSheet("QComboBox {\n"
"    color: rgb(0, 0, 0);\n"
"    border-style: solid;\n"
"    border-width: 1px;\n"
"    border-radius: 5px;\n"
...
"    selection-color: rgb(246, 246, 246);\n"
"}")
        self.calendarioAddCombo1_2.setObjectName("calendarioAddCombo1_2")
        self.calendarioAddForm_3.addWidget(self.calendarioAddCombo1_2, 4, 1, 1, 1)
        self.calendarioAddLabel1_2 = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        self.calendarioAddLabel1_2.setStyleSheet("color: rgb(151, 151, 151);")
        self.calendarioAddLabel1_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.calendarioAddLabel1_2.setObjectName("calendarioAddLabel1_2")
        self.calendarioAddForm_3.addWidget(self.calendarioAddLabel1_2, 3, 1, 1, 1)
        self.calendarioAddForm_3.setColumnStretch(0, 5)
        self.calendarioAddForm_3.setColumnStretch(1, 2)
        self.calendarioAddForm_3.setColumnStretch(2, 2)
        self.seguimientoMarkVLayout.addLayout(self.calendarioAddForm_3)
...
"border-radius: 10px;")
        ...
        self.calendarioAddForm_2 = QtWidgets.QGridLayout()
        self.calendarioAddForm_2.setObjectName("calendarioAddForm_2")
        self.calendarioAddLineEdit_2 = QtWidgets.QLineEdit(self.verticalLayoutWidget_6)
        self.calendarioAddLineEdit_2.setStyleSheet("QLineEdit {\n"
"    color: rgb(0, 0, 0);\n"
"    border-style: solid;\n"
"    border-width: 1px;\n"
"    border-radius: 5px;\n"
...
"    border-width: 2px;\n"
"}")
        self.calendarioAddLineEdit_2.setObjectName("calendarioAddLineEdit_2")
        self.calendarioAddForm_2.addWidget(self.calendarioAddLineEdit_2, 4, 0, 1, 1)
        self.calendarioAddLabel0_2 = QtWidgets.QLabel(self.verticalLayoutWidget_6)
        self.calendarioAddLabel0_2.setStyleSheet("color: rgb(151, 151, 151);")
        self.calendarioAddLabel0_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.calendarioAddLabel0_2.setObjectName("calendarioAddLabel0_2")
        self.calendarioAddForm_2.addWidget(self.calendarioAddLabel0_2, 3, 0, 1, 1)
        self.calendarioAddBtn1_2 = QtWidgets.QPushButton(self.verticalLayoutWidget_6)
        self.calendarioAddBtn1_2.setStyleSheet("QPushButton {\n"
"    border-width: 0px;\n"
"    color: rgb(255, 255, 255);\n"
"    background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0, stop:0 rgba(28, 85, 255, 255), stop:1 rgba(94, 134, 255, 255));\n"
"    padding: 6.5px;\n"
...
"    background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0, stop:0 rgba(32, 81, 227, 255), stop:1 rgba(71, 109, 224, 255));\n"
"}")
        self.calendarioAddBtn1_2.setObjectName("calendarioAddBtn1_2")
        self.calendarioAddForm_2.addWidget(self.calendarioAddBtn1_2, 4, 1, 1, 1)
        self.calendarioAddForm_2.setColumnStretch(0, 5)
        self.seguimientoClassVLayout.addLayout(self.calendarioAddForm_2)
...
"border-radius: 10px;")
        ...
        self.verticalLayoutWidget_9.setGeometry(QtCore.QRect(0, -4, 341, 241))
...
"}")
        ...
        # self.seguimientoGrid.setRowStretch(1, 10)
        # self.seguimientoGrid.setRowStretch(3, 5)
        # self.seguimientoGrid.setRowStretch(5, 5)
...
"  0 Amigos"))
        ...
        self.seguimientoClassTitle_2.setText(_translate("MainWindow", "Añade tu último resultado"))
        self.calendarioAddBtn1_3.setText(_translate("MainWindow", "Crea"))
        self.calendarioAddCombo2_2.setItemText(0, _translate("MainWindow", "60%"))
        self.calendarioAddCombo2_2.setItemText(1, _translate("MainWindow", "40%"))
        self.calendarioAddLabel0_3.setText(_translate("MainWindow", "Resultado de la prueba"))
        self.calendarioAddLabel2_2.setText(_translate("MainWindow", "Porcentaje"))
        self.calendarioAddLabel1_2.setText(_translate("MainWindow", "Clase"))
        self.seguimientoClassTitle.setText(_translate("MainWindow", "Crea una clase"))
        self.calendarioAddLabel0_2.setText(_translate("MainWindow", "Nombre de la clase"))
        self.calendarioAddBtn1_2.setText(_translate("MainWindow", "Crea"))
        ...
        self.accountMainNameLabel.setText(_translate("MainWindow", "@username"))
        self.accountMainVariableBtn.setText(_translate("MainWindow", "Seguir"))
        self.accountMainFriendsLabel.setText(_translate("MainWindow", "0 Amigos"))
        self.accountDescLabel.setText(_translate("MainWindow", "@username se ha conectado a BoxPile 0 veces y ha subido 0 notas."))
