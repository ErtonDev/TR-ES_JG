...
"min-height: 150;")
        ...
        self.busquedaResultsList.itemClicked.connect(self.busquedaResultsListEvent)
        ...
        if sidebar_placed == True:
            ...
            if index == 5:
                if visit != "None":
                    ...
                    self.displayPopup("Selecciona un nombre de usuario para visitar su perfíl.")
            else:
                current_index = index
                self.retranslateUi(MainWindow)
                self.stackedWidget.setCurrentIndex(index)
    ...
    def showUserData(self):
        ...
        popup.setText(f"Datos del curso actual:\nVeces conectado a BoxPile: {connections}\nResultados subidos a BoxPile: {submitted}")
    ...
    def followOrUnfollow(self):
        ...
        if client in friendship:
            ...
            self.accountMainVariableBtn.setText("Seguir")
            self.accountMainVariableBtn.setStyleSheet("QPushButton {\n"
"    border-width: 0px;\n"
"    color: rgb(255, 255, 255);\n"
"    background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0, stop:0 rgba(28, 85, 255, 255), stop:1 rgba(94, 134, 255, 255));\n"
...
"}")
            ...
            self.accountMainVariableBtn.setText("Pendiente")
            self.accountMainVariableBtn.setStyleSheet("QPushButton {\n"
"    border-width: 2px;\n"
"    border-style: solid;\n"
...
"  Sesión"))
        ...
        if current_index == 4:
            friends_list = list(api.get_users(conn, "friends", "name", f"'{client}'"))
            friends_num = len(friends_list)
            requests_list = list(api.get_users(conn, "requests", "name", f"'{client}'"))
            ...
            self.userMainFriendsLabel.setText(_translate("MainWindow", f"{friends_num} Amigos"))
        ...
        if current_index == 5:
            ...
            self.accountDescLabel.setText(_translate("MainWindow", f"@{visit} se ha conectado a BoxPile {connections} veces y ha subido {submitted} resultados."))
...
"}")
                ...
                self.accountMainVariableBtn.setText("Dejar de seguir")
                self.accountMainVariableBtn.setStyleSheet("QPushButton {\n"
"    border-width: 0px;\n"
"    color: rgb(255, 255, 255);\n"
"    background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0, stop:0 rgba(254, 140, 10, 255), stop:1 rgba(255, 190, 94, 255));\n"
