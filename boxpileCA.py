...
"}")
    ...
    def doLogin(self):
        ...
        if query == "f":
            self.displayPopup("L'usuari no existeix")
        else:
            if query != passInput:
                self.displayPopup("La contrasenya no es correspon amb l'usuari")
            else:
    ...
    def doRegister(self):
        ...
        if userInput == "" or passInput == "":
            self.displayPopup("S'han d'omplir tots els espais per poder crear una compte.")
        else:
            repeat = api.get_users(conn, "id", "name", f"'{userInput}'")

            if repeat == "f":
                popup = QMessageBox()
                popup.setWindowTitle("Nova compta")
                popup.setText(f"El compte '{userInput}' serà registrat amb la contrasenya '{passInput}.'")
                popup.setDetailedText("Caracters ilegals son eliminats quan es crea un compte (" + '"' + "," + " '" + ")")
                ...
                self.displayPopup(f"L'usuari {userInput} ja existeix.")
    ...
    def addEvent(self):
        ...
        if event_name != "":
            ...
            if event_name in db_day:
                self.displayPopup(f"L'event {event_name} ja existeix aquest dia.")
                return
...
"}")
        ...
        if name != "":
            ...
            for i in db_classes:
                if name.lower() == i[0].lower():
                    self.displayPopup(f"La classe {name} ja existeix.")
                    return
    ...
    def addMark(self):
        ...
        try:
            ...
            self.displayPopup("Introdueix un valor entre 0 i 10 per afegir un resultat i recalcular.")
            return
    ...
    def showUserData(self):
        ...
        popup.setText(f"Detalls del curs actual:\nConexions: {connections}\nResultats pujats: {submitted}")
    ...
    def restartCourse(self):
        ...
        popup = QMessageBox()
        popup.setWindowTitle("Resetejar el curs")
        popup.setText("Totes les dades del curs actual s'eliminaran permanentment.")
        popup.setIcon(QMessageBox.Warning)
        popup.setStandardButtons(QMessageBox.Close | QMessageBox.Ok)
        popup.setDefaultButton(QMessageBox.Close)
        result = popup.exec_()
...
"text-align: left")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnCalendario.setText(_translate("MainWindow", "Calendari"))
        self.btnSeguimiento.setText(_translate("MainWindow", "Seguiment"))
        self.btnBusqueda.setText(_translate("MainWindow", "Busqueda"))
...
"  ~"))
        ...
        if current_index == 0:
            ...
            self.loginPassLineEdit.setPlaceholderText(_translate("MainWindow", "Contrasenya"))
            self.loginUserLineEdit.setPlaceholderText(_translate("MainWindow", "Usuari"))
            self.registerBtn.setText(_translate("MainWindow", "Sign In"))
            self.loginBtn.setText(_translate("MainWindow", "Log In"))

        if current_index == 1:
            self.calendarioMainD7.setText(_translate("MainWindow", "Diumenge"))
            self.calendarioMainD1.setText(_translate("MainWindow", "Dilluns"))
            self.calendarioMainD2.setText(_translate("MainWindow", "Dimarts"))
            self.calendarioMainD3.setText(_translate("MainWindow", "Dimecres"))
            self.calendarioMainD4.setText(_translate("MainWindow", "Dijous"))
            self.calendarioMainD5.setText(_translate("MainWindow", "Divendres"))
            self.calendarioMainD6.setText(_translate("MainWindow", "Dissabte"))
            self.calendarioMainD8.setText(_translate("MainWindow", "Borrar"))
            self.calendarioMainVaciarExpl.setText(_translate("MainWindow", "Borra tots els events marcats en un dia per reorganitzar-lo."))
            self.calendarioMainVaciarLabel.setText(_translate("MainWindow", "Dia"))
            self.calendarioMainCombo.setItemText(0, _translate("MainWindow", "Dilluns"))
            self.calendarioMainCombo.setItemText(1, _translate("MainWindow", "Dimarts"))
            self.calendarioMainCombo.setItemText(2, _translate("MainWindow", "Dimecres"))
            self.calendarioMainCombo.setItemText(3, _translate("MainWindow", "Dijous"))
            self.calendarioMainCombo.setItemText(4, _translate("MainWindow", "Divendres"))
            self.calendarioMainCombo.setItemText(5, _translate("MainWindow", "Dissabte"))
            self.calendarioMainCombo.setItemText(6, _translate("MainWindow", "Diumenge"))
            self.calendarioMainVaciarBtn.setText(_translate("MainWindow", "Borrar"))
            self.calendarioAddTitle.setText(_translate("MainWindow", "Crear un nou event"))
            self.calendarioAddBtn3.setText(_translate("MainWindow", "Reiniciar l'event"))
            self.calendarioAddLabel0.setText(_translate("MainWindow", "Nom de l'event"))
            self.calendarioAddCombo1.setItemText(0, _translate("MainWindow", "Dilluns"))
            self.calendarioAddCombo1.setItemText(1, _translate("MainWindow", "Dimarts"))
            self.calendarioAddCombo1.setItemText(2, _translate("MainWindow", "Dimecres"))
            self.calendarioAddCombo1.setItemText(3, _translate("MainWindow", "Dijous"))
            self.calendarioAddCombo1.setItemText(4, _translate("MainWindow", "Divendres"))
            self.calendarioAddCombo1.setItemText(5, _translate("MainWindow", "Dissabte"))
            self.calendarioAddCombo1.setItemText(6, _translate("MainWindow", "Diumenge"))
            self.calendarioAddLabel1.setText(_translate("MainWindow", "Dia"))
            if sharing != []:
                self.calendarioAddLabel2.setText(_translate("MainWindow", f"Compartint amb {len(sharing)} ({sharing[0]}, ...)"))
            else:
            ...
            self.calendarioAddBtn2.setText(_translate("MainWindow", "Afegir"))
        ...
        if current_index == 2:
            ...
            self.seguimientoMarkTitle.setText(_translate("MainWindow", "Afegeix l'ultim resultat"))
            ...
            self.seguimientoMarkLabel1.setText(_translate("MainWindow", "Resultat de la proba"))
            self.seguimientoMarkLabel3.setText(_translate("MainWindow", "Percentage"))
            self.seguimientoMarkLabel2.setText(_translate("MainWindow", "Classe"))
            self.seguimientoClassTitle.setText(_translate("MainWindow", "Crea una classe"))
            self.seguimientoClassLabel1.setText(_translate("MainWindow", "Nom de la classe"))
            self.seguimientoClassBtn1.setText(_translate("MainWindow", "Crear"))
            self.seguimientoMainTitle.setText(_translate("MainWindow", "Mitjana"))
            self.seguimientoMainMark.setText(_translate("MainWindow", db_classes[current_subindex][3]))
            if db_classes[current_subindex][7] == "N/a No avaluat":
                self.seguimientoMainSubtitle.setText(_translate("MainWindow", "No avaluat"))
            else:
                self.seguimientoMainSubtitle.setText(_translate("MainWindow", f"Actualitzat en {db_classes[current_subindex][7]}"))
            if db_classes[current_subindex][0] != "Global":
                self.seguimientoInMainTitle.setText(_translate("MainWindow", "Historial global" + db_classes[current_subindex][0]))
            else:
            ...
            if db_classes[current_subindex][11] == "N/a No hay datos":
                self.seguimientoInMainPrev1.setText(_translate("MainWindow", "N/a No avaluat"))
            else:
            ...
            if db_classes[current_subindex][10] == "N/a No hay datos":
                self.seguimientoInMainPrev2.setText(_translate("MainWindow", "N/a No avaluat"))
            else:
            ...
            if db_classes[current_subindex][9] == "N/a No hay datos":
                self.seguimientoInMainPrev3.setText(_translate("MainWindow", "N/a No avaluat"))
            else:
            ...
            if db_classes[current_subindex][8] == "N/a No hay datos":
                self.seguimientoInMainPrev4.setText(_translate("MainWindow", "N/a No avaluat"))
            else:
            ...
            if self.seguimientoInMainPrev1.text() != "N/a No avaluat" and self.seguimientoInMainPrev2.text() != "N/a No avaluat":
            ...
            if self.seguimientoInMainPrev2.text() != "N/a No avaluat" and self.seguimientoInMainPrev3.text() != "N/a No avaluat":
            ...
            if self.seguimientoInMainPrev3.text() != "N/a No avaluat" and self.seguimientoInMainPrev4.text() != "N/a No avaluat":
            ...
            self.seguimientoInMainBtn1.setText(_translate("MainWindow", "Seguemnt"))
            self.seguimientoInMainBtn2.setText(_translate("MainWindow", "Anterior"))
        ...
        if current_index == 4:
            ...
            self.userMainVariableBtn.setText(_translate("MainWindow", "Detalls"))
            self.userMainCourseBtn.setText(_translate("MainWindow", "Reset curs"))
            if friends_num == 1:
                self.userMainFriendsLabel.setText(_translate("MainWindow", f"{friends_num} Amic"))
            else:
                self.userMainFriendsLabel.setText(_translate("MainWindow", f"{friends_num} Amics"))
            self.userPickerLabel.setText(_translate("MainWindow", "Customitza el teu perfil:"))
            self.userFriendsLabel1.setText(_translate("MainWindow", "Amics"))
            self.userFriendsLabel2.setText(_translate("MainWindow", "Solicituds d'amistat"))
            self.userFriendsAcceptBtn.setText(_translate("MainWindow", "Acceptar"))
            self.userFriendsDeclineBtn.setText(_translate("MainWindow", "Declinar"))
